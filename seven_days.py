...
class SevenDaysScraper:
    ...
    def main(self):
        ...
        for urls in self.df1['url'].values:
            ...
            pic5 = None
            try:
                owners = self.driver.find_element("xpath", '//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div[4]/a/div/span[1]/div').text
                floor_price = self.driver.find_element("xpath", '//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div[6]/a/div/span[1]/div').text
                items = self.driver.find_element("xpath", '//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div[2]/a/div/span[1]/div').text
            except:
                owners = 'None'
                floor_price = 'None'
                items = 'None'
