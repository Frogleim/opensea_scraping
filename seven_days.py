...
class SevenDaysScraper:
    ...
    def scroll(self):
        ...
        while self.num != 90:
            ...
            for items in divs:
                ...
                print('Done!')
                SevenDaysScraper.data_info.append(d)
    ...
    def main(self):
        ...
        screen_height = self.driver.execute_script("return window.screen.height;")  # get the screen height of the web
        self.df1 = pd.DataFrame(SevenDaysScraper.data_info).drop_duplicates()
        i = 1
        for urls in self.df1['url'].values:
            ...
            try:
                items = driver.find_element(By.XPATH,
                                            ...
                                            '2]/button/div/span[1]/div').text
                owners = driver.find_element(By.XPATH,
                                             '//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div['
                                             '4]/a/div/span[1]/div').text
                floor_price = driver.find_element(By.XPATH,
                                                  '//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div['
            ...
            try:
                img1 = self.driver.find_element(By.XPATH,'//*[@id="main"]/div/div/div[2]/div/div[1]/div/button/div/img')
            ...
            try:
                ...
                blockchain = 'None'
            try:
                web_site = self.driver.find_element(By.XPATH,
                    '//*[@id="main"]/div/div/div[3]/div/div/div[2]/div/div/div[1]/div/div[1]/a[2]')
                website = web_site.get_attribute('href')
            except:
                website = None

            try:
                twit = self.driver.find_element(By.XPATH,
                    '//*[@id="main"]/div/div/div[3]/div/div/div[2]/div/div/div[1]/div/div[1]/a[3]')
                twitter = twit.get_attribute('href')
            except:
                twitter = None
            try:
                disc = self.driver.find_element(By.XPATH,
                    '//*[@id="main"]/div/div/div[3]/div/div/div[2]/div/div/div[1]/div/div[1]/a[3]')
                discord = disc.get_attribute('href')
            except:
                discord = None
            main_d = {
                'owners': owners,
            ...
            print(main_d)
            SevenDaysScraper.data_2.append(main_d)
    ...
    def run_all(self):
        ...
        self.scroll()
        df1 = pd.DataFrame(SevenDaysScraper.data_info).drop_duplicates()
        self.main()
        df2 = pd.DataFrame(SevenDaysScraper.data_2).drop_duplicates()
        df1.merge(df2, left_index=True, right_index=True).to_json('all_data.xlsx')
        print('Seven days data is ready!')


if __name__ == '__main__':
    mydaily = SevenDaysScraper()
    mydaily.run_all()
