...
class SevenDaysScraper:
    ...
    def __init__(self) -> None:
        ...
        self.url = 'https://opensea.io/rankings?sortBy=seven_day_volume'
    ...
    def main(self):
        ...
        for urls in self.df1['url'].values:
            ...
            pic5 = None
            try:
                owners = self.driver.find_element_by_xpath('//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div[4]/a/div/span[1]/div').text
                floor_price = self.driver.find_element_by_xpath('//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div[6]/a/div/span[1]/div').text
                items = self.driver.find_element_by_xpath('//*[@id="main"]/div/div/div[5]/div/div[1]/div/div[3]/div/div[2]/a/div/span[1]/div').text
            except:
                owners = 'None'
                floor_price = 'None'
                items = 'None'
    ...
    def run_all(self):
        ...
        df1.merge(df2, left_index=True, right_index=True).to_json('seven_days_data.json', orient="index")
